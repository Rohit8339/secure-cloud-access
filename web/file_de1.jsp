                ...
                <div class="content_resize"> <img src="images/up.jpg" width="958" height="245" alt="" class="hbg_img" />
                    ...
                    <table border="1" style="text-align: center;margin-left: 220px">
                        <tr>
                            ...
                            <th style="text-align: center;width: 200px;color: black; font-size: 14px">Time</th>
                        ...
                        <%
                            ...
                            try {
                                ...
                                rs = st.executeQuery("select * from file_view where username!='" + user + "'");
                                while (rs.next()) {
                        ...
                        <tr>
                            ...
                            <td style="color: #4CAF50; font-size: 16px"><a href="request_sent.jsp?fname=<%=rs.getString("file_name")%>&uname=<%=user%>&oname=<%=rs.getString("username")%>"><font style="color: green">Sent</a></td>
