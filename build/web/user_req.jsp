...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <%
        ...
        %>
        <script>alert('Response Sent to User..');</script>
        <%            }
        %>
    <body>
        <div class="main">
                ...
                <div class="content_resize"> <img src="images/up.jpg" width="958" height="245" alt="" class="hbg_img" />
                    ...
                    <table border="1" style="text-align: center;margin-left: 200px">
                        <tr>
                            ...
                            <th style="text-align: center;width: 100px;color: black; font-size: 14px">Request From</th>
                        ...
                        <%
                            ...
                            try {
                                ...
                                rs = st.executeQuery("select * from userrequests where status='Request'");
                                while (rs.next()) {
                        ...
                        <tr>
                            ...
                            <td style="color: midnightblue; font-size: 16px"><%=rs.getString("status")%></td> 
