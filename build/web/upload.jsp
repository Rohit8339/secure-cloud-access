...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
     ...
     <%
        ...
        %>
        <script>alert('File Uploaded to DriveHQ Cloud...');</script>
        <%            }
        %>
    <%
        ...
        %>
        <script>alert('The Given File Contains Deduplicated Content. File Uploading Process is Terminated');</script>
        <%            }
        %>
    <style> 
